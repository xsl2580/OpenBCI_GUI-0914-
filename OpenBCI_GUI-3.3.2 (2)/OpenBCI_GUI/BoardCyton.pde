...
class Cyton {
  ...
  private final int fsHzSerialCyton = 1000;  //sample rate used by OpenBCI board...set by its Arduino code
  private final int fsHzSerialCytonDaisy = 1000;  //sample rate used by OpenBCI board...set by its Arduino code
